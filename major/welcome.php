...
<head>
    ...
    <title>WELCOME TO CROPZEN</title>
...
<body>
    <div class="grid-container">
        <div class="section sec-1">
            <h2>WELCOME TO CROPZEN</h2>
            <a class="btn btn-outline-success " type="submit" href="login.php"target="_blank"><i class="fa-solid fa-right-to-bracket"></i>
            Login</a>
            <a class="btn btn-outline-success" type="submit" href="signup.php"target="_blank"><i class="fa-solid fa-user-plus"></i>
            Signup</a>
        </div>
    </div>
